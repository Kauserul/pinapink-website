  ...
  return (
    <div className='bg-red-500 p-5 min-h-screen'>
            <div className='bg-white w-4/5  rounded-xl text-center mx-auto py-2 font-bold mb-7'>
                <h2 className=''>Welcome to PinaPink Seller</h2>
            </div>
            <form>
                <div className='mb-3'>
                ...
                <div className='mb-3'>
                    ...
                    <select className="w-full rounded outline-none px-2">
                ...
                <div className='mb-3'>
                    <label className='block text-white'>Business Name</label>
                    <input className='w-full rounded outline-none px-2' required type='text'></input>
                </div>
                <div className='mb-3'>
                    <label className='block text-white'>Caregory (Food, lifestyle, fashion & beauty, tech etc.)</label>
                    <input className='w-full rounded outline-none px-2' required type='text'></input>
                </div>
                <div className='mb-3'>
                ...
                <div className='mb-3'>
                    ...
                    <input className='w-full rounded outline-none px-2'  type='number'></input>
                </div>
                
                <div className='text-center'>
                    <button className='btn btn-primary bg-white rounded-sm border-none mt-5 text-black'>Submit Form</button>
                </div>
            </form>
        </div>
  )
